...
public class OrderController {
    ...
    @Operation(summary = "按配送员查询订单", description = "查看某个配送员名下的所有订单")
    @GetMapping("/courier/{courierId}")
    @LogExecution
    public Result<List<Order>> getOrdersByCourierId(
            @Parameter(description = "配送员 ID") @PathVariable Long courierId) {
        return Result.success(orderService.findByCourierId(courierId));
    }
